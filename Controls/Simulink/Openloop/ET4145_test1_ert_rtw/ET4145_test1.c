...
B_ET4145_test1_T ET4145_test1_B;

/* Block states (default storage) */
DW_ET4145_test1_T ET4145_test1_DW;

/* Previous zero-crossings (trigger) states */
PrevZCX_ET4145_test1_T ET4145_test1_PrevZCX;

/* Real-time model */
static RT_MODEL_ET4145_test1_T ET4145_test1_M_;
RT_MODEL_ET4145_test1_T *const ET4145_test1_M = &ET4145_test1_M_;
 ...
 */
void ET4145_test1_SetEventsForThisBaseStep(boolean_T *eventFlags)
{
  /* Task runs when its counter is zero, computed via rtmStepTask macro */
  eventFlags[1] = ((boolean_T)rtmStepTask(ET4145_test1_M, 1));
}
...
static void rate_monotonic_scheduler(void)
{
   ...
   */
  (ET4145_test1_M->Timing.TaskCounters.TID[1])++;
  if ((ET4145_test1_M->Timing.TaskCounters.TID[1]) > 9) {/* Sample time: [0.01s, 0.0s] */
    ET4145_test1_M->Timing.TaskCounters.TID[1] = 0;
  }
}

/* Model step function for TID0 */
void ET4145_test1_step0(void)          /* Sample time: [0.001s, 0.0s] */
{
  ...
  /* S-Function (c2802xadc): '<Root>/ADC_MOSFET_ON' */
  {
    ...
    asm(" RPT #22 || NOP");
    ET4145_test1_B.ADC_MOSFET_ON = (AdcResult.ADCRESULT0);
  }

  /* RelationalOperator: '<Root>/Relational Operator1' incorporates:
   *  Constant: '<Root>/Constant3'
   */
  rtb_RelationalOperator1 = (ET4145_test1_P.Constant3_Value <=
    ET4145_test1_B.ADC_MOSFET_ON);
  ...
  /* S-Function (c2802xadc): '<Root>/VoltMeas' */
  {
    ...
    /* Wait for the period of Sampling window and EOC result to be latched after trigger */
    asm(" RPT #22 || NOP");
    ET4145_test1_B.VoltMeas = (AdcResult.ADCRESULT8);
  }
  ...
  rtb_LogicalOperator4 = ((!rtb_RelationalOperator1) &&
    (ET4145_test1_P.Constant14_Value < ET4145_test1_B.VoltMeas));

  /* Outputs for Triggered SubSystem: '<Root>/Sample and Hold1' incorporates:
   *  TriggerPort: '<S1>/Trigger'
   */
  if (rtb_LogicalOperator4 && (ET4145_test1_PrevZCX.SampleandHold1_Trig_ZCE !=
       POS_ZCSIG)) {
    /* Inport: '<S1>/In' incorporates:
     *  Constant: '<Root>/Constant15'
     */
    ET4145_test1_B.In_g = ET4145_test1_P.Constant15_Value;
  }

  ET4145_test1_PrevZCX.SampleandHold1_Trig_ZCE = rtb_LogicalOperator4;
   ...
   */
  rtb_LogicalOperator4 = (rtb_RelationalOperator1 ||
    ET4145_test1_P.Constant9_Value || ET4145_test1_B.In_g);

  /* DataTypeConversion: '<Root>/Data Type Conversion1' */
  rtb_DataTypeConversion1 = rtb_LogicalOperator4;
  ...
  /* S-Function (c2802xadc): '<Root>/ADC_IGBT_ON' */
  {
    ...
    /* Wait for the period of Sampling window and EOC result to be latched after trigger */
    asm(" RPT #22 || NOP");
    ET4145_test1_B.ADC_IGBT_ON = (AdcResult.ADCRESULT2);
  }

  /* RelationalOperator: '<Root>/Relational Operator3' incorporates:
   *  Constant: '<Root>/Constant8'
   */
  rtb_RelationalOperator3 = (ET4145_test1_P.Constant8_Value <=
    ET4145_test1_B.ADC_IGBT_ON);
  ...
  rtb_LogicalOperator2 = ((ET4145_test1_P.Constant13_Value <
    ET4145_test1_B.VoltMeas) && rtb_LogicalOperator2_tmp);

  /* Outputs for Triggered SubSystem: '<Root>/Sample and Hold2' incorporates:
   *  TriggerPort: '<S2>/Trigger'
   */
  if (rtb_LogicalOperator2 && (ET4145_test1_PrevZCX.SampleandHold2_Trig_ZCE !=
       POS_ZCSIG)) {
    /* Inport: '<S2>/In' incorporates:
     *  Constant: '<Root>/Constant16'
     */
    ET4145_test1_B.In = ET4145_test1_P.Constant16_Value;
  }

  ET4145_test1_PrevZCX.SampleandHold2_Trig_ZCE = rtb_LogicalOperator2;
   ...
   */
  rtb_RelationalOperator3 = (ET4145_test1_B.In ||
    (ET4145_test1_P.Constant9_Value || rtb_RelationalOperator3));

  /* DataTypeConversion: '<Root>/Data Type Conversion4' */
  rtb_DataTypeConversion4 = rtb_RelationalOperator3;

  /* Logic: '<Root>/NOT1' incorporates:
   *  Logic: '<Root>/Logical Operator6'
   */
  ET4145_test1_B.NOT1 = ((!ET4145_test1_B.In_g) && (!ET4145_test1_B.In));

  /* Logic: '<Root>/NOT2' incorporates:
   *  Logic: '<Root>/Logical Operator7'
   */
  ET4145_test1_B.NOT2 = ((!rtb_RelationalOperator1) || rtb_LogicalOperator2_tmp);

  /* Logic: '<Root>/NOT3' incorporates:
   *  Logic: '<Root>/Logical Operator8'
   */
  ET4145_test1_B.NOT3 = (rtb_LogicalOperator4 && rtb_RelationalOperator3);

  /* S-Function (c280xgpio_do): '<Root>/BlueLED' */
  {
    if (ET4145_test1_B.NOT3)
  ...
  {
    EPwm1Regs.CMPA.half.CMPA = (uint16_T)(ET4145_test1_P.Constant7_Value);
  }

  EPwm1Regs.AQCSFRC.bit.CSFA = rtb_DataTypeConversion4;
  ...
  {
    EPwm2Regs.CMPA.half.CMPA = (uint16_T)(ET4145_test1_P.Constant_Value);
  }

  EPwm2Regs.AQCSFRC.bit.CSFA = rtb_DataTypeConversion1;

  /* RateTransition: '<Root>/Rate Transition5' */
  ET4145_test1_B.RateTransition5 = ET4145_test1_DW.RateTransition5_Buffer0;

  /* S-Function (c280xgpio_do): '<Root>/Eanble Output' */
  {
    if (ET4145_test1_B.RateTransition5)
...
void ET4145_test1_step1(void)          /* Sample time: [0.01s, 0.0s] */
{
  /* RateTransition: '<Root>/Rate Transition5' */
  ET4145_test1_DW.RateTransition5_Buffer0 = ET4145_test1_P.Constant6_Value;
}

/* Model initialize function */
void ET4145_test1_initialize(void)
{
  /* Registration code */

  /* initialize real-time model */
  (void) memset((void *)ET4145_test1_M, 0,
                sizeof(RT_MODEL_ET4145_test1_T));

  /* block I/O */
  (void) memset(((void *) &ET4145_test1_B), 0,
                sizeof(B_ET4145_test1_T));

  /* states (dwork) */
  (void) memset((void *)&ET4145_test1_DW, 0,
                sizeof(DW_ET4145_test1_T));
  ...
  EDIS;
  ET4145_test1_PrevZCX.SampleandHold1_Trig_ZCE = POS_ZCSIG;
  ET4145_test1_PrevZCX.SampleandHold2_Trig_ZCE = POS_ZCSIG;

  /* InitializeConditions for RateTransition: '<Root>/Rate Transition5' */
  ET4145_test1_DW.RateTransition5_Buffer0 =
    ET4145_test1_P.RateTransition5_InitialConditio;

  /* SystemInitialize for Triggered SubSystem: '<Root>/Sample and Hold1' */
  /* SystemInitialize for Outport: '<S1>/ ' incorporates:
   *  Inport: '<S1>/In'
   */
  ET4145_test1_B.In_g = ET4145_test1_P._Y0;

  /* End of SystemInitialize for SubSystem: '<Root>/Sample and Hold1' */

  /* SystemInitialize for Triggered SubSystem: '<Root>/Sample and Hold2' */
  /* SystemInitialize for Outport: '<S2>/ ' incorporates:
   *  Inport: '<S2>/In'
   */
  ET4145_test1_B.In = ET4145_test1_P._Y0_a;

  /* End of SystemInitialize for SubSystem: '<Root>/Sample and Hold2' */
}

/* Model terminate function */
void ET4145_test1_terminate(void)
{
