...
## Generated on : Thu Sep 01 10:38:31 2022
...
PRODUCT_NAME              = Openloop_voltage_control
MAKEFILE                  = Openloop_voltage_control.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Openloop_voltage_control.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Openloop_voltage_control_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/tic2000/inc -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/shared/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/shared/SUPPOR~1/tic2000/inc -IC:/ti/CONTRO~1/DEVICE~1/f2802x/v230/F2802X~1/include -IC:/ti/CONTRO~1/DEVICE~1/f2802x/v230/F2802X~4/include -IC:/ti/CONTRO~1/DEVICE~1/f2802x/v230 -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_STANDARD = -DMODEL=Openloop_voltage_control -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_adc.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_csl.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Openloop_voltage_control.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/Openloop_voltage_control.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Openloop_voltage_control_data.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/Openloop_voltage_control_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/Openloop_voltage_control_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
