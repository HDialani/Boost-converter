###########################################################################
## Makefile generated for component 'ET4145_test1'. 
## 
## Makefile     : ET4145_test1.mk
## Generated on : Tue Sep 06 11:28:16 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ET4145_test1.out
...
PRODUCT_NAME              = ET4145_test1
MAKEFILE                  = ET4145_test1.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/hites/Desktop/GITHUB~1/BOOSTC~1/BOOST-~1/Controls/Simulink/CONTRO~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ET4145_test1.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/ET4145_test1_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/tic2000/inc -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/shared/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/shared/SUPPOR~1/tic2000/inc -IC:/ti/CONTRO~1/DEVICE~1/f2802x/v230/F2802X~1/include -IC:/ti/CONTRO~1/DEVICE~1/f2802x/v230/F2802X~4/include -IC:/ti/CONTRO~1/DEVICE~1/f2802x/v230 -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_SKIPFORSIL = -DDAEMON_MODE=1 -DXCP_CUSTOM_PLATFORM -DMW_PIL_SCIFIFOLEN=4 -DSTACK_SIZE=512 -DRT -DF28027 -DBOOT_FROM_FLASH=1
DEFINES_STANDARD = -DMODEL=ET4145_test1 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/ET4145_test1_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/ET4145_test1_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/ET4145_test1_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/ET4145_test1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_board.obj : $(START_DIR)/ET4145_test1_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ET4145_test1.obj : $(START_DIR)/ET4145_test1_ert_rtw/ET4145_test1.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ET4145_test1_data.obj : $(START_DIR)/ET4145_test1_ert_rtw/ET4145_test1_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/ET4145_test1_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_csl.obj : $(START_DIR)/ET4145_test1_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/ET4145_test1_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/ET4145_test1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
